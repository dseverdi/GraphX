## Paket koji implementira pretrazivanje grafa: DFS, BFS
...
class BFSearch:
    ...
    def find_path(self,v):
        ...
        if v==self._s : self._path.append(self._s),
        elif not self._pi[v]:
            return None
        else:
            self.find_path(self._pi[v])
            self._path.append(v)
      
    def pathTo(self,v):
        """ vrati listu vrhova na putu od s do v"""
        self._path = []
        self.find_path(v)
        return self._path
